...
import { FilterChatModal } from "../Components/Messages/SelectUserForChat/FilterChatModal";
...
export const Messages = () => {
  ...
  const closeModal = () => setOpenModal((prevState) => !prevState);
  ...
  return (
    <>
      <div className="messages-mount">
        ...
        {/* Production: Modal for selecting friend to chat with */}
        {/* {openModal && (
          <Modal closeModal={closeModal}>
            <FilterChatModal users={users} />
          </Modal>
        )} */}
      </div>
    </>
