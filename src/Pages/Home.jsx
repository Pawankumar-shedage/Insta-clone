...
export const Home = () => {
  ...
  const updatePost = async (postId, newPostData, userId, username) => {
    console.log("Called", newPostData);
    ...
    console.log("Post update successfull:", newPostData);
  };
  ...
  const handleLike = async (post) => {
    ...
    const postLikedByCurrUser = likedByArray.includes(currentUser.uid)
      ? true
      : false;
